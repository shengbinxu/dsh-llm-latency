...
export declare function canonicalModel(model: string, aliases: ModelAliases): string;
/** Every distinct canonical model present across a set of model ids, sorted. */
export declare function distinctCanonicals(models: readonly string[], aliases: ModelAliases): string[];
